...
function moretrace(){
	...
	echo '正在进行路由跟踪，请稍后...'
	echo '---------------------------------------------------------------------------'
	echo '【广州电信】 - 202.96.128.1'
	echo ''
	./besttrace -q 1 202.96.128.1
	echo '---------------------------------------------------------------------------'

	echo '【广州联通】- 221.5.88.1'
	echo ''
	./besttrace -q 1 221.5.88.1
	echo '---------------------------------------------------------------------------'

	echo '【广州移动】 - 211.136.20.1'
	echo ''
	./besttrace -q 1 211.136.20.1
	echo '---------------------------------------------------------------------------'
	
	echo '【上海电信】 - 202.96.199.1'
	echo ''
	./besttrace -q 1 202.96.199.1
	echo '---------------------------------------------------------------------------'

	echo '【上海联通】- 139.227.180.1'
	echo ''
	./besttrace -q 1 139.227.180.1
	echo '---------------------------------------------------------------------------'

	echo '【上海移动】 - 211.136.150.1'
	echo ''
	./besttrace -q 1 211.136.150.1
	echo '---------------------------------------------------------------------------'
